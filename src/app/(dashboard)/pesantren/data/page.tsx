                ...
                <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden">
                    {loading ? (
                        ...
                        <div className="text-center py-16 text-slate-400">
                            {searchTerm ? "Tidak ada santri yang cocok." : "Belum ada data santri."}
                        </div>
                    ) : (
                                ...
                                {filteredSantri.map((santri) => (
                                    <tr key={santri.id} className="hover:bg-slate-800/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            <span className={`px-2 py-1 rounded text-xs ${santri.status === 'Aktif' ? 'bg-emerald-500/10 text-emerald-500' : 'bg-amber-500/10 text-amber-500'}`}>
                                                {santri.status}
                                            </span>
                                        </td>
                                    </tr>
