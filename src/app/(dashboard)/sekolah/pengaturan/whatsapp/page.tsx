...
import { MessageCircle, QrCode, Wifi, WifiOff, Send, RefreshCw, Loader2, Crown, AlertTriangle, CheckCircle2 } from "lucide-react";
...
export default function WhatsAppSettingsPage() {
    ...
    const [isPremium, setIsPremium] = useState(true); // Will be fetched from subscription
            ...
            <div className="max-w-2xl mx-auto py-12 px-4">
                <div className="bg-gradient-to-br from-amber-500/10 to-orange-500/10 border border-amber-500/30 rounded-2xl p-8 text-center">
                    ...
                    <p className="text-slate-400 mb-6">
                        ...
                        Upgrade sekarang untuk menghubungkan nomor WhatsApp Anda sendiri.
                    </p>
                    <a
                        href="/upgrade"
                        className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-amber-500 to-orange-500 text-white font-semibold rounded-xl hover:opacity-90 transition"
                    >
                ...
                <div className="bg-slate-800/50 border border-slate-700 rounded-2xl p-6 mb-6">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <p className="text-slate-400 text-sm text-center">
                            Buka WhatsApp di HP Anda → Menu → WhatsApp Web → Scan QR Code ini
                        </p>
                    </div>
                </div>
            )}
            ...
            {status === "connected" && (
                <div className="bg-slate-800/50 border border-slate-700 rounded-2xl p-6">
                    ...
                    <div className="space-y-4">
                        <div>
                            <label className="block text-sm text-slate-400 mb-1">Nomor WhatsApp Tujuan</label>
                            <input
                                type="text"
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={3}
                                className="w-full px-4 py-2 bg-slate-900 border border-slate-700 rounded-lg text-white focus:outline-none focus:border-emerald-500 resize-none"
                            />
                        </div>
                        ...
                        <button
                            ...
                            className="px-4 py-2 bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 transition flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {sendingTest ? (
                ...
                <div className="flex gap-3">
                    ...
                    <div className="text-sm text-blue-300">
                        ...
                        <ul className="list-disc list-inside space-y-1 text-blue-300/80">
                            <li>WhatsApp hanya bisa terhubung ke satu perangkat dalam satu waktu</li>
                            <li>Pastikan HP Anda tetap online untuk pengiriman pesan</li>
                            <li>Fitur ini untuk mengirim notifikasi tagihan & pembayaran ke wali murid</li>
                        </ul>
                    </div>
                </div>
            </div>
